...
public class CadastroReservaApiServiceImpl extends CadastroReservaApiService {
    @Override
    public Response addReserva(Reserva reserva, SecurityContext securityContext) throws NotFoundException {
    	try {
